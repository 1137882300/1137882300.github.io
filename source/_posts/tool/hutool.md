...
String str = StrUtil.format(template, "马斯克", "马斯克");
// 马斯克，一枚沉默但有趣的程序员，喜欢他的文章的话，请微信搜索马斯克
```
...
public class SecureUtilDemo {
    ...
    public static void main(String[] args) {
        String encry = aes.encryptHex("马斯克");
