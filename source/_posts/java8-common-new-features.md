...
tags:
   - java8
description:  Java8的新特性总结
date: 2020-06-22
keywords: 'Java8,java8,java'
cover: https://cdn.jsdelivr.net/gh/1137882300/images@master/images%E6%BE%B3%E5%A4%A7%E5%88%A9%E4%BA%9A.png
abbrlink: 112225
---
...
使用 `Optional` 解决 NPE（`java.lang.NullPointerException`）问题，它就是为 NPE 而生的，其中可以包含空值或非空值。下面我们通过源码逐步揭开 `Optional` 的红盖头。
